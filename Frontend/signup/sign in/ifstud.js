...
function submitForm() {
    ...
    // Passing out year validation
    if (isNaN(passingOutYear) || passingOutYear < currentYear) {
        errorMessage += "Passing out year must be the current year or a future year.<br>";
    }
