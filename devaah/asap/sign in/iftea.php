...
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'teacher') {
    ...
    header("Location: ../login/login.php"); // Change to your login page or error page
    exit();
}

// Database connection
include "../db.php"; // Adjusted to use relative path (modify based on your directory structure)
...
if ($result) {
    ...
    echo "Error fetching subjects: " . $conn->error; // Display error if query fails
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (count($errors) === 0) {
        ...
        if ($stmt->execute()) {
            ...
            echo "<script>alert('Details saved successfully!'); window.location.href = '../login/login.php';</script>";
        } else {
...
<head>
    ...
    <script src="iftea.js"></script> <!-- Link to your JavaScript file -->
</head>
<body>
<div class="modal">
