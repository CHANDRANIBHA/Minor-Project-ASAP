...
<body>
    ...
    const stdId = studentId; // studentId should be the user_id (unique identifier)

    // Construct the URL with all parameters
   const url = `hash2.php?class_id=${classId}&semester=${semester}&subject_id=${subjectId}&std_id=${stdId}&mode=${mode}`;
